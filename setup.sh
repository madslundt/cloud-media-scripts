...
# RUN THIS AFTER
echo "Now run rclone with the command:"
echo "\t ./${rclone_bin} --config=${rclone_cfg}"
echo "You need to setup following:"
...
echo "Now run plexdrive with the command:"
echo "\t ./${plexdrive_bin} --config ${plexdrive_dir}"
echo "Cancel plexdrive by pressing CTRL+C"
echo "Run plexdrive with screen by running the following commands:"
